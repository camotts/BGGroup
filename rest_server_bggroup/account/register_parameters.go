...
import (
	...
	"github.com/camotts/bggroup/rest_model_bggroup"
)
...
type RegisterParams struct {
	...
	// Body.
	Body *rest_model_bggroup.RegisterRequest
...
func (o *RegisterParams) WithBody(body *rest_model_bggroup.RegisterRequest) *RegisterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the register params
func (o *RegisterParams) SetBody(body *rest_model_bggroup.RegisterRequest) {
	o.Body = body
}
